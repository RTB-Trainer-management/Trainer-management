...
const Signup = () => {
  return (
    <div className="bg-[#1D5FAD] text-[#868585] flex items-center justify-center min-h-screen ">
      <div className="bg-white rounded-xl p-8 w-200 shadow-lg my-10">
...
<div className="text-[#868585] text-sm font-medium flex items-center justify-center space-x-4 mb-10">
  ...
  <span>.</span>
  <Link to="/school-management" className="bg-[#1D5FAD] p-3 text-white rounded-2xl">School Manager</Link>
  <span>.</span>
...
<div>
          ...
          <div className="space-y-6 mx-5.5 my-0.5">
            ...
            <div>
              <label htmlFor="school" className="block text-[#868585] text-sm font-medium mb-1">
                School Name
              </label>
              <input
                id="school"
            ...
            <div>
              <label htmlFor="certificate" className="block text-[#868585] text-sm font-medium mb-1">
                Certificate
              </label>
              <input
                id="certificate"
