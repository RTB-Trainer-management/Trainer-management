      ...
      {openView && selectedTrainer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden">
            ...
            <div className="p-6 flex gap-6 text-gray-800">
              {/* Left – Feedback */}
              <div className="flex-1 border-r border-gray-500 border-r-5 pr-6">
                <h4 className="font-semibold text-gray-900 mb-3">Feedback Information</h4>
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-medium">Rejection Message:</span> {selectedTrainer.message}
                </p>
              </div>

              {/* Right – Appeal */}
              <div className="flex-1 pl-2">
                <h4 className="font-semibold text-gray-900 mb-3">Appealing Information</h4>
